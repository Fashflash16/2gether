                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 infocol">
                            ...
                            <a href="friend_profile.php?u=<?php echo $id ?>"><h4><img src="<?php echo $rows['avatar'] ?>" alt="" class="img-circle" width="40px"/> <?php echo "&nbsp;"; echo $rows['first_name']; echo " "; echo $rows['last_name'] ?></h4></a>
                            ...
                            <div class="panel panel-default">
                                <div class="view-all-comments">
                                        ...
                                        <span class="likes pull-right padding-v-5-1"><i class="fa fa-thumbs-up fa-lg"></i>&emsp;100 likes</span>
                                            ...
                                            while($rowcomm=$comm->fetch_assoc()) { ?>
                                                ...
                                                <li class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <?php if ($rowcomm['com_by']==$row['id']) { ?>
                                                            <div class="pull-right dropdown" data-show-hover="li">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li><a href="#" onclick="document.getElementById('deletecom1').submit();">Delete</a></li>
                                                                </ul>
                                                            </div>
                                                            <form id="deletecom1" action="parse/delete_comments.php" method="post" class="hidden">
                                                        ...
                                                        <?php } else { ?>
      <a href="friend_photos.php?u=<?php echo $rowcomm['com_by']; ?>"  class="comment-author pull-left">
                                                        <?php }

                                                         echo "<span>".$rowcomm['first_name']."</span>"; ?></a>
                   ...
                   <img src="<?php echo $row['avatar'] ?>" width="35" class="media-object"/>
                                                ...
                                                <select id="postid5" name="postid" class="hidden"><option value="<?php echo $rowpostpic['postid'] ?>"></option></select>
                                                <input id="comment5" type="text" name="comment" class="form-control" />
