            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="" method="post">
                    ...
                    <div id="share-buttons" class="panel-footer share-buttons">
                        ...
                        <button id="submitpost" type="button" name="postatexxt" class="btn btn-inverse btn-xs pull-right display-none" href="#" disabled>Post</button>
                    </div>
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div id="share-buttons" class="panel-footer share-buttons">
                        ...
                        <button id="submitpost" type="button" name="postaphoto" class="btn btn-inverse btn-xs pull-right" disabled>Post</button>
                    </div>
    ...
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform1" name="postform1" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div id="share-buttons" class="panel-footer share-buttons">
                        <select name="posted_to" class="hidden"><option value="<?php echo $id ?>"></option></select>
                        <button id="submitpost" type="button" name="postavideo" class="btn btn-inverse btn-xs pull-right" disabled>Post</button>
                    </div>
        ...
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="" method="post">
                    ...
                    <div id="share-buttons" class="panel-footer share-buttons">
                        <select name="posted_to" class="hidden"><option value="<?php echo $id ?>"></option></select>
                        <button id="submitpost" type="button" name="postayoutube" class="btn btn-inverse btn-xs pull-right" disabled>Post</button>
                    </div>
        ...
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="" method="post">
                    ...
                    <div id="share-buttons" class="panel-footer share-buttons">
                        <select name="posted_to" class="hidden"><option value="<?php echo $id ?>"></option></select>
                        <button id="submitpost" type="button" name="postavimeo" class="btn btn-inverse btn-xs pull-right" disabled>Post</button>
                    </div>
        ...
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="" method="post">
                    ...
                    <div id="share-buttons" class="panel-footer share-buttons">
                        <select name="posted_to" class="hidden"><option value="<?php echo $id ?>"></option></select>
                        <button id="submitpost" type="button" name="postalink" class="btn btn-inverse btn-xs pull-right" disabled>Post</button>
                    </div>
