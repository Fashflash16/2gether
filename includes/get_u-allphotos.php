<?php
        ...
        $allpic = $conn->query("SELECT id, img_thumb, img_src, img_title, img_desc, uploaded_by, uploaded_at, img_privacy, album_id FROM photos WHERE uploaded_by=$frindex");
...
<?php } ?>
                                    ...
                                    <button class="btn btn-white btn-xs pull-right" data-toggle="modal" data-target="#edit-pics<?php echo $picid ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><i class="fa fa-pencil"></i></button>
                                </p>
                                        ...
                                        if($phcom->num_rows > 0) {
                                            while($rowphcom=$phcom->fetch_assoc()) { ?>
                                                ...
                                                <div class="pull-right dropdown" data-show-hover="li">
                                                            ...
                                                            <form id="deletecom3" action="parse/delete_photocomments.php" method="post" class="hidden">
                   ...
                   <img src="<?php echo $row['avatar'] ?>" width="35" class="media-object"/>
                                                ...
                                                <select id="photopostid1" name="photoid" class="hidden"><option value="<?php echo $picid ?>"></option></select>
                                                <input id="photocomment1" type="text" name="phcomment" class="form-control" />
...
<!-- all photos modal end -->
                ...
                <!-- edit/delete photos start -->

                <div class="modal fade" id="edit-pics<?php echo $picid ?>" role="dialog">
                                        ...
                                        <ul class="list-unstyled profile-about margin-none">
                                            ...
                                            <li class="padding-v-5" style="margin-top: 10px">
                                                <div class="row form-group">
                                                    ...
                                                    <div><button type="button" name="delete" id="delete" class="btn btn-danger pull-right" data-toggle="modal" data-target="#deleteallpics<?php echo $picid ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><i class="fa fa-trash" style="color: white"></i></button>
                                                    </div>
                                                    <div class="pull-right">&emsp;</div>
                                                    <div>
                ...
                <div class="modal fade" id="deleteallpics<?php echo $picid ?>" role="dialog">
                    <?php
