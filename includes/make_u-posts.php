<div id="posttext" class="col-xs-12 col-md-6 col-lg-4 item">
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            <div id="showhidden" class="panel-heading panel-heading-gray title">
                What&acute;s new
                <div class="pull-right dropdown" data-show-hover="#showhidden">
                    <a href="#" data-toggle="dropdown" class="toggle-button">
                        <i class="fa fa-eye-slash"></i>
                    </a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#" onclick="document.getElementById('showposts').submit();">Show hidden posts</a></li>
                    </ul>
                </div>
            </div>
            <form id="showposts" action="parse/show_posts.php" method="post" class="hidden">
                <input type="text" name="show" value="<?php echo $row['id'] ?>">
            </form>

            <div class="panel-body">

                <form id="postform" name="postform" action="parse/post_u-text.php" method="post">
    ...
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="parse/post_u-photo.php" method="post"  enctype="multipart/form-data">
    ...
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform1" name="postform1" action="parse/post_u-video.php" method="post" enctype="multipart/form-data">
                        ...
                        <li class="padding-v-5" style="margin-top: 5px">
                            <div class="row form-group">
                                ...
                                <div id="postvidupl" class="col-sm-9">
                                    <input type="file" name="postvid" id="file-1" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" style="display: none" />
    ...
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="parse/post_u-youtube.php" method="post">
    ...
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="parse/post_u-vimeo.php" method="post">
                    ...
                    <ul class="list-unstyled profile-about margin-none">
                        ...
                        <li class="padding-v-5">
                            <div class="row form-group padding-v-0-7">
                                <div class="col-sm-2"><span class="text-muted">Location</span></div>
                                <div class="col-sm-5"><input type="text" name="postcity" class="form-control" maxlength="100" placeholder="<?php include ('includes/get_city.php'); ?>" required></div>
                                <div class="col-sm-5">
    ...
    <div class="timeline-block">
        <div class="panel panel-default share clearfix-xs">
            ...
            <div class="panel-body">
                ...
                <form id="postform" name="postform" action="parse/post_u-link.php" method="post">
                            ...
                            <div class="row form-group padding-v-0-7">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    if (mysqli_num_rows($rescountry) > 0) { ?>
                                        ...
                                        <select name="postcountry" id="postlinkco" class="form-control" required>
