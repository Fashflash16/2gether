...
$postpic = $conn->query("SELECT id, img_thumb, img_src, img_title, img_desc, uploaded_by, uploaded_at, img_privacy, album_id FROM photos WHERE album_id=4 AND uploaded_by=$id");
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 infocol">
                            ...
                            <a href="friend_profile.php?u=<?php echo $id ?>"><h4><img src="<?php echo $rows['avatar'] ?>" alt="" class="img-circle" width="40px"/> <?php echo "&nbsp;"; echo $row['first_name']; echo " "; echo $rows['last_name'] ?></h4></a>
