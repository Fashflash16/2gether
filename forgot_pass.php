        ...
        <div class="panel panel-default text-center">
          ...
          <div class="panel-body" style="margin-top:-20px">
             <?php if (isset($_GET['mssg'])) { ?>
                  <br /><p style="color:red"><?php echo $_GET['mssg'] ?></p>
                  <?php } else { ?>
              ...
              <form role="form" data-toggle="validator" name="forgot_form" id="forgot_form" action="parse/forgot.php" method="POST">
            ...
            <button class="btn btn-primary text-right" type="submit" name="forgot" id="forgot" style="width: 100px">Send <i class="fa fa-fw fa-send-o"></i></button>
