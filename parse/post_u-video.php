...
//unlink($temp); // Remove the uploaded file from the PHP temp folder
        ...
        $conn->query("INSERT INTO posts (id, body, added_at, added_by, posted_to, post_city, post_country, post_cat, post_privacy, post_hide, post_status) VALUES (DEFAULT, '$postbody', now(), $userid, $userid, $cityid, $postcountry, 3, 1, 0, 0)");
