...
if(isset($_POST['postbody'])) {
    ...
    if(isset($_POST['postvimeo'])) {

     $url = $_POST['postvimeo'];
     $res = substr($url, 18);
     $link = "https://player.vimeo.com/video/$res";



        $conn->query("INSERT INTO posts (id, body, added_at, added_by, posted_to, post_city, post_country, post_cat, post_privacy, post_hide, post_status) VALUES (DEFAULT, '$postbody', now(), $userid, $userid, $cityid, $postcountry, 5, 1, 0, 0)");
