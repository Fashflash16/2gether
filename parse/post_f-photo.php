    ...
    if(isset($_FILES['postpic']['name'])) {
        ...
        if (empty($errors)) {
            ...
            if (move_uploaded_file($temp, $path)) {
                    ...
                    $conn->query($ins1 = "INSERT INTO posts (id, body, added_at, added_by, posted_to, post_city, post_country, post_cat, post_privacy, post_hide, post_status) VALUES (DEFAULT, '$postbody', now(), $userid, $id, $cityid, $postcountry, 2, 1, 0, 0)");

                    $conn->query($ins2 = "INSERT INTO photoposts (id, photopost_title, photopost_thumb, photopost_src, photopost_path, post_id) VALUES(DEFAULT, '$postpictit', '$img_thumb', '$img_src', '$path1', LAST_INSERT_ID())");
