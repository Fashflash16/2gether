...
if(isset($_POST['postbody'])) {
    ...
    if(isset($_POST['postlink'])) {
     ...
     $link = $_POST['postlink'];
         ...
         $conn->query("INSERT INTO posts (id, body, added_at, added_by, posted_to, post_city, post_country, post_cat, post_privacy, post_hide, post_status) VALUES (DEFAULT, '$postbody', now(), $userid, $id, $cityid, $postcountry, 6, 1, 0, 0)");
