...
if(isset($_POST['postbody'])) {
    ...
    if(isset($_POST['postyoutube'])) {

     $url = $_POST['postyoutube'];
     $res = substr($url, 32);
     $link = "https://www.youtube.com/embed/$res";



        $conn->query("INSERT INTO posts (id, body, added_at, added_by, posted_to, post_city, post_country, post_cat, post_privacy, post_hide, post_status) VALUES (DEFAULT, '$postbody', now(), $userid, $userid, $cityid, $postcountry, 4, 1, 0, 0)");
