        ...
        if (isset($_POST['postcity'])) {
            if (!empty($_POST['postcity'])) {
                ...
                if ($city_check->num_rows == 0) {
                    ...
                    $conn->query("INSERT INTO posts (id, body, added_at, added_by, posted_to, post_city, post_country, post_cat, post_privacy, post_hide, post_status) VALUES (DEFAULT, '$postbody', now(), $userid, $userid, $cityid, $postcountry, 1, 1, 0, 0)");
                    ...
                    $conn->query("INSERT INTO posts (id, body, added_at, added_by, posted_to, post_city, post_country, post_cat, post_privacy, post_hide, post_status) VALUES (DEFAULT, '$postbody', now(), $userid, $userid, $usercity, $postcountry, 1, 1, 0, 0)");
